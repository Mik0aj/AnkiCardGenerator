...
class Word_Fetcher():
    def __init__(self, record_folder, image_folder, file_name, usr_agent, src="auto", dest="en", ):
        ...
        # All images and recordings are stored in designeted folders. They don't change during runtime.
        # So to save up memory i have decided to use generetors to store the name and address of all jpg and mp3.
    ...
    def __download_images(self, links, image_folder, usr_agent):
        ...
        for i, link in enumerate(links):
            ...
            if matches:
                print(
                    "Image was found for {start} : {match} downloading image and saving it in {folder}/{name}.jpg".format(
                        start=word,
